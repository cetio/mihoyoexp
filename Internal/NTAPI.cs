...
namespace Mihoyo.Internal
{
    public static unsafe class NTAPI
    {
        ...
        public static extern unsafe uint ZwMapViewOfSection(IntPtr section, IntPtr process, ref IntPtr baseAddr, int zeroBits, ulong commitSize, LARGE_INTEGER* stuff, ref ulong viewSize, int inheritDispo, uint alloctype, uint prot);
        ...
        public static extern unsafe uint RtlGetVersion(_OSVERSIONINFOEXW* lpVersionInformation);

        [DllImport("ntdll.dll", SetLastError = true)]
        public static extern unsafe int NtQueryInformationProcess(IntPtr processHandle, int processInformationClass, void* processInformation, int processInformationLength, IntPtr returnLength);
